...
test_clips = pd.read_csv('../labeled_data/train_val_test_clips/test_clips.csv', index_col=[0,1,2]) 
print(test_clips.sum())

model = opensoundscape.ml.cnn.load_model('../train/model_states/best.model')
...
#save output 
test_all.to_csv('../labeled_data/train_val_test_clips/test_clips_prediction.csv')
