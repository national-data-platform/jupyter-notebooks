...
import pandas as pd
import numpy as np
sys.path.append(r"/srv/starter_content/_User-Persistent-Storage_/AB_classifier")
from AudioStreamDescriptor import XWAVhdr

directory_path = "../labeled_data/logs" # point to original logger files
all_files = glob.glob(os.path.join(directory_path,'*.xls')) # path for all files

new_base_path = '/srv/starter_content/_Shared-Storage_/AB_classifier/wav_files' # path to change to 
