...
DCPP01A = pd.read_csv('../labeled_data/logs/modified_annotations/DCPP01A_logs_from_cv4e_modification.csv')
SOCAL34N = pd.read_csv('../labeled_data/logs/modified_annotations/MoreConservativeSOCAL34N_modification.csv')
...
# save dataframes
train_clips_final.to_csv('../labeled_data/train_val_test_clips/train_clips.csv')
balanced_val_clips.to_csv('../labeled_data/train_val_test_clips/val_clips_balanced.csv')  
test_clips.to_csv('../labeled_data/train_val_test_clips/test_clips.csv')
