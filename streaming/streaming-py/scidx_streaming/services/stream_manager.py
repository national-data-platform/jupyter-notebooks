...
async def create_stream(self, payload):
    ...
    filtered_streams = await search_datasets_based_on_keywords(self, payload["keywords"], payload["match_all"])
...
async def search_datasets_based_on_keywords(self, keywords_list, match_all):
    ...
    if match_all and keywords_list:
        ...
        filtered_streams = self.search_datasets()
